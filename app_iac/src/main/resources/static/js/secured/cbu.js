function _isLengthOk(cbu) {
    return (cbu.length == 22);
};

function _isValidAccount(acc) {
    if (acc.length !== 14) {
        return false;
    }
...
function _isValidBankCode(code) {
    if (code.length !== 8) {
        return false;
    }
 ...
 */
function getAssociatedBank(cbu) {
